class Program
{
    ...
    {
        // Variáveis para armazenar informações de 5 heróis
        ...
        // Controle do loop principal do menu
        bool sair = false;
        ...
        while (!sair)
        {
            ...
            {
                case "1":
                    // Cadastro dos 5 heróis chamando o método cadastrarHeroi
                ...
                case "2":
                    // Seleciona a equipe de 3 heróis
                    selecionarEquipe(
                        Hero1, poder1, point1,
                        Hero2, poder2, point2,
                        Hero3, poder3, point3,
    ...
    // Método para cadastrar um herói individualmente
    static void cadastrarHeroi(ref string Hero, ref string poder, ref int point, int numero)
    {
        Console.WriteLine($"\nCadastro do Herói {numero}:");
        Console.Write("Hero: ");
        Hero = Console.ReadLine(); // Nome do herói
        Console.Write("Poder: ");
        poder = Console.ReadLine(); // Poder do herói
        Console.Write("Pontuação: ");
        point = int.Parse(Console.ReadLine()); // Pontuação do herói
    }

    // Método para selecionar 3 heróis para a equipe
        ...
        ref string equipe3, ref string poderEquipe3, ref int pontEquipe3)
    {
        ...
        // Solicita a escolha dos 3 heróis para a equipe
        ...
        // Atribui os heróis escolhidos à equipe chamando o método atribuirHeroi
    ...
    // Método que atribui os dados do herói escolhido à equipe
        ...
        string equipe3, string poder3, int pont3)
    {
        ...
        // Calcula e exibe a pontuação total da equipe
        int total = calcularpointTotal(pont1, pont2, pont3);
        Console.WriteLine($"\nPontuação Total da Equipe: {total}");
    }

    // Método que soma a pontuação dos 3 heróis da equipe
